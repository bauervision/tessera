    ...
    <>
      <div className="mx-auto max-w-6xl">
        <div className="px-6 pb-8">
          ...
          <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex flex-col items-start gap-2 sm:items-end">
              <Link
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-sky-400/60 bg-sky-500/10 text-sky-100 shadow-sm transition hover:border-sky-300/80 hover:bg-sky-500/20"
              >
          ...
          {/* Main layout: left = DRD + calendar, right = companies */}
          <div className="mt-4 grid grid-cols-1 gap-2 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,1.3fr)] lg:items-start">
            {/* Left column: Dashboard meetings / DRD panel */}
            <div className="min-w-0">
              <DashboardMeetingsPanel />
            </div>

            {/* Right column: company panels */}
            <div className="min-w-0">
                    ...
                    >
                      <header className="mb-3 flex items-center justify-between gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-500/40 bg-slate-900 text-slate-200 hover:border-slate-300/70 hover:bg-slate-800"
                        >
                          {/* simple pencil icon */}
                          <svg
                            viewBox="0 0 20 20"
                      ...
                      <ul className="space-y-1.5 text-sm">
                            ...
                            <li key={p.id} className="relative">
                              ...
                              {priority === "hot" && !archived && (
                                <button
                                  ...
                                  className="absolute right-2 top-2 z-20 rounded-full bg-slate-900/90 px-2.5 py-1 text-[10px] font-medium text-amber-200 shadow-sm ring-1 ring-amber-400/70 transition hover:bg-amber-500 hover:text-slate-950"
                                >
                                  Archive?
                                </button>
                              )}
                              ...
                              <Link
                                ...
                                className={`group block overflow-hidden rounded-2xl bg-linear-to-r ${visuals.borderGradient} p-px`}
                              >
                                <div
                        ...
                        <li>
                          <button
                            ...
                            className="group flex w-full items-center justify-center rounded-2xl border border-dashed border-sky-500/60 bg-sky-500/5 px-3 py-2 text-[12px] font-medium text-sky-100 hover:border-sky-300/80 hover:bg-sky-500/15"
                          >
